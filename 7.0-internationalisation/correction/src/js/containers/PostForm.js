        ...
        return (
            <Modal display={this.props.display} onClick={() => { this.props.dispatch(push('/')) }}>
                <section className={`post-form`}>
                    <h3><FormattedMessage id="app.add_picture" /></h3>
                    <form onSubmit={this.props.handleSubmit}>
                        <div className="form-group">
                            <label><FormattedMessage id="app.post_form.picture" /></label>
                            <Field
                                component={FileInput}
                        ...
                        <div className="form-group">
                            <label><FormattedMessage id="app.post_form.filter" /></label>
                            <Field
                                component="select"
                                className="form-control"
                                name="filter"
                        ...
                        <div className="form-group">
                            <label><FormattedMessage id="app.post_form.description" /></label>
                            <Field
                                component="textarea"
                                className="form-control"
                                name="description"
                        ...
                        <div className="form-group">
                            <button
                                ...
                                <FormattedMessage id="app.post_form.add" />
                            </button>
                        </div>
                    </form>
                </section>
